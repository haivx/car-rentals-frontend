...
export const SideBar = () => {
  ...
  return (
    <>
          ...
          <div className="sidebar-list">
            <ul className="navbar-nav iq-main-menu nav nav-tabs" id="sidebar-menu" role="tablist">
              <li className="nav-item">
                <a
                  className="nav-link {{#compare active '==' 'index'}}active{{/compare}}"
                  aria-current="page"
                  href="{{path}}dashboard/index.html"
              ...
              <li className="nav-item">
                <a
                  onClick={onToggle}
                  className={`nav-link nav-panel ${sideContent === 'sidebar-active' ? 'active' : ''}`}
                  href="#sidebar-auths"
                  id="auth-pages"
                  data-bs-toggle="tab"
                  data-sidebar-toggle="tooltip"
                  data-bs-placement="right"
                  data-bs-target="#sidebar-auths"
                  role="tab"
              ...
              <li className="nav-item">
                <a
                  className={`nav-link nav-panel ${sideContent === 'error' ? 'active' : ''}`}
                  // className="nav-link nav-panel {{#compare sidebar-active '==' 'error'}}active{{/compare}}"
                  href="#sidebar-utilitiess"
                  id="users-error"
                  data-bs-toggle="tab"
                  data-sidebar-toggle="tooltip"
                  data-bs-placement="right"
                  data-bs-target="#sidebar-utilitiess"
                  role="tab"
                  aria-controls="sidebar-utilities"
                  aria-selected="false"
                  title="Utility"
                >
                  <i className="icon">
              ...
              <li className="nav-item">
                <a
                  onClick={onToggle}
                  // className="nav-link {{#compare active '==' 'map-vector'}}active{{/compare}}"
                  className={`nav-link nav-panel ${sideContent === 'map-vector' ? 'active' : ''}`}
                  href="{{path}}dashboard/maps/vector.html"
                  data-sidebar-toggle="tooltip"
                  data-bs-placement="right"
                  data-bs-target="#sidebar-map"
                  aria-selected="false"
                  title="Maps"
                >
                  <i className="icon">
              ...
              <li className="nav-item">
                <a
                  // className="nav-link {{#compare active '==' 'dual-tone-icon'}}active{{/compare}}"
                  className={`nav-link nav-panel ${sideContent === 'dual-tone-icon' ? 'active' : ''}`}
                  href="{{path}}dashboard/icons/dual-tone.html"
                  data-sidebar-toggle="tooltip"
                  data-bs-placement="right"
                  data-bs-target="#sidebar-icons"
                  aria-selected="false"
                  title="Icons"
                >
                  <i className="icon">
              ...
              <li className="nav-item">
                <a
                  className="nav-link"
                  href="https://templates.iqonic.design/lite/vroom/html/dist/"
                  data-sidebar-toggle="tooltip"
                  data-bs-placement="right"
                  title="UI Kit"
                >
      ...
      <div
        onClick={onToggle}
        className={`tab-content sidebar sidebar-default navs-rounded-all ${isToggle ? '' : 'in-active'}`}
        //   {{#compare isSideContent "!==" "true"}}
        // in-active {{/ compare}}"
        id="nav-tabContent"
      >
        <div className="sidebar-header d-flex align-items-center justify-content-start">
        ...
        <div className="tab-pane fade show active" id="sidebar-auths" role="tabpanel" aria-labelledby="auth-pages">
            ...
            <ul className="navbar-nav" id="sidebar-menu-auth">
              <li className="nav-item">
                ...
                <ul className="sub-nav collapse show" id="sidebar-auth" data-bs-parent="#sidebar-menu-auth">
                  <li className="nav-item">
                    <a className="nav-link" href="{{path}}dashboard/auth/sign-in.html">
                      <i className="icon">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="{{path}}dashboard/auth/sign-up.html">
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="{{path}}dashboard/auth/confirm-mail.html">
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="{{path}}dashboard/auth/lock-screen.html">
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="{{path}}dashboard/auth/recoverpw.html">
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
        ...
        <div className="tab-pane fade" id="sidebar-users" role="tabpanel" aria-labelledby="users-pages">
          <div className="sidebar-body">
            <ul className="navbar-nav" id="sidebar-menu-users">
              <li className="nav-item">
                <a
                  className="nav-link"
                  data-bs-toggle="collapse"
                  ...
                  role="button"
                  aria-expanded="true"
                  aria-controls="sidebar-menu-users"
                >
                  <i className="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <ul className="sub-nav collapse show" id="sidebar-user" data-bs-parent="#sidebar-menu-users">
                  <li className="nav-item">
                    <a
                      className="nav-link {{#compare active '==' 'user-profile'}}active{{/compare}}"
                      href="{{path}}dashboard/app/user-profile.html"
                    >
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link {{#compare active '==' 'user-add'}}active{{/compare}}"
                      href="{{path}}dashboard/app/user-add.html"
                    >
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                  ...
                  <li className="nav-item">
                    <a
                      className="nav-link {{#compare active '==' 'user-list'}}active{{/compare}}"
                      href="{{path}}dashboard/app/user-list.html"
                    >
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
        ...
        <div className="tab-pane fade" id="sidebar-utilitiess" role="tabpanel" aria-labelledby="users-error">
          <div className="sidebar-body">
            <ul className="navbar-nav" id="sidebar-menu-utilities">
              <li className="nav-item">
                <a
                  className="nav-link"
                  data-bs-toggle="collapse"
                  href="#sidebar-utilities"
                  role="button"
                  aria-expanded="true"
                  aria-controls="sidebar-menu-utilities"
                >
                  <i className="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <ul className="sub-nav collapse show" id="sidebar-utilities" data-bs-parent="#sidebar-menu-utilities">
                  <li className="nav-item">
                    <a className="nav-link " href="{{path}}dashboard/errors/error404.html">
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <li className="nav-item">
                    <a className="nav-link " href="{{path}}dashboard/errors/error500.html">
                      <i className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                          <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
